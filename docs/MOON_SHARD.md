...
The victory handler places the relic above the traveler during the existing
two-page reward dialogue. A small bob and limited yaw show its depth without
...
inventory invariance, both dialogue pages and map-exit cleanup. For an actual
