...
const DATA: Dictionary = {
	"traveler": {"name": "戰士", "description": "均衡的近戰冒險者，揮出月影斬迎擊周圍敵人。", "hp": 100, "mp": 20, "attack": 14, "defense": 2, "skill": "月影斬", "cost": 5, "cooldown": 3.0, "power": 12, "radius": 2.2, "glyph": "moon", "cue": "moon_slash", "reach": 1.65, "interval": 0.38, "dodge": 1.0, "ranged": false, "effect": "moon_slash", "color": Color("e6c58b")},
