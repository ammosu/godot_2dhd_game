...
func _run() -> void:
	...
	_check(Footsteps.surface_at(self, Vector3(0, 0.01, 0)) == &"dirt", "Rural gravel trail still sounds like paving")
	world.call("_load_map", "caravan_road", "default")
	_check(Footsteps.surface_at(self, Vector3(-18, 0.022, 22)) == &"dirt", "Caravan polygon ignores dirt surface")
