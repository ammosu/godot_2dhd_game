# ada: eight-direction walk atlas
...
Specified villager: bottom row first character: Ada, gray-haired older woman tailor, bun, spectacles, rose dress burgundy vest, cream embroidered fabric and sewing pouch

Targeted correction (selected final output):
Edit this original NPC sprite sheet. Preserve the complete 4 column by 8 row arrangement, transparent RGBA background, character identity, gray bun, rose dress, burgundy vest, glasses, apron, sewing cloth, and all other rows EXACTLY. Correct ONLY ROW FOUR (the row immediately above the straight-back row): all four poses in row four must face BACK-LEFT / UP-LEFT toward the image's upper LEFT corner. Currently they erroneously face toward the right like row six. Draw the rear LEFT three-quarter view: back of head and bun dominant, LEFT edge of cheek or glasses may show at image LEFT, nose pointing LEFT, shoulders oriented upper left. Keep four different walk phases in this row matching neutral / left contact / passing / right contact, same size and baseline. Do not mirror the entire sheet. Do not change row six, which correctly faces back-right. All sprites separated by clear transparent gutters, no shadows or scenery or text.
