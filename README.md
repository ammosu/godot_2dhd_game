...
3. 取得月印、開啟北方月紋雙扇門後前往北境遺跡；途中可閱讀風化石碑並在月泉恢復 HP／MP。
4. 接受遺跡守衛的試煉，運用攻擊、月影斬、藥水與防禦贏得戰鬥。
5. 從南方門扉返回村莊，將月光碎片交給長老並點亮月燈。
...
原生 Android／iOS 版會鎖定為感應式橫向，可隨手機左右翻轉；PWA 匯出的方向偏好也預設為橫向。若一般手機瀏覽器不允許網頁強制方向，直向畫面會顯示旋轉提示。
