...
- 戰鬥中按 `1`～`5` 選擇攻擊、月光彈、藥水、防禦、霜星爆，再點「確認」或按 Enter；Tab 可切換敵方卡片與指令按鈕。
...
本版諾亞與長老是試煉援軍，每場恢復初始 HP／MP，尚無永久隊伍編成；旅人 HP／MP 與藥水仍由 GameState 保存。旅人倒下但隊伍獲勝時以 1 HP 起身。戰鬥中途不存檔，因此無新增存檔欄位，version 1 存檔仍相容。諾亞與長老暫沿用探索立繪，專用施法／受擊姿勢仍待補。
